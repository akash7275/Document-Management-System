<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectCategory.aspx.cs" Inherits="SelectTemplate" EnableEventValidation="false" %>
...
<body>
    ...
    <h3 style="text-align:center;" ">Select the Category </h3>
    
        <div>
            <asp:Repeater ID="rptSelectCategory" runat="server">
                <ItemTemplate>
                    <div style=" color: white; display: inline-block; padding: .6%; margin: 2px;width:15%; list-style: none; border-radius: 4%;">
                        <ul>
                            <li style="list-style: none;">
                                <asp:Button ID="btnDocName" Width="100%" class="btn" runat="server" Text='<%#Eval("Name")%>' CommandName='<%#Eval("Id")%>' CommandArgument='<%#Eval("Id")%>' OnClick="btnDocName_Click"></asp:Button>
